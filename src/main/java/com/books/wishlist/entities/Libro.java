...
public class Libro {
	...
	@NotBlank(message = "Identificacdor <b>unico</b> el cual conicide con el id del libro en el API Books de Google.")
	...
	@Column(name="title")
	@NotBlank(message = "Nombre del titulo del libro no puede ser vacio.")
	...
	@NotBlank(message = "Nombre de la editorial asociada al libro no puede ser vacia.")
	...
	@Column(name="authors")
	@NotBlank(message = "Nombre de los autores del libro no debe ser vacio.")
